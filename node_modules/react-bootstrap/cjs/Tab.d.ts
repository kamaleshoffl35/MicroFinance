...
import { type TabPaneProps } from './TabPane.js';
...
declare const _default: React.FC<TabProps> & {
    Container: {
        ({ transition, ...props }: import("./TabContainer.js").TabContainerProps): import("react/jsx-runtime").JSX.Element;
        displayName: string;
    };
    Content: import("@restart/ui/types").DynamicRefForwardingComponent<"div", import("./TabContent.js").TabContentProps>;
