...
declare const _default: DynamicRefForwardingComponent<"div", ToastProps> & {
    Body: DynamicRefForwardingComponent<"div", import("./ToastBody.js").ToastBodyProps>;
    Header: React.ForwardRefExoticComponent<import("./ToastHeader.js").ToastHeaderProps & React.RefAttributes<HTMLDivElement>>;
};
