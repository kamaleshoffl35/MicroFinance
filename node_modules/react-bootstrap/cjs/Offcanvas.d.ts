...
declare const _default: React.ForwardRefExoticComponent<Omit<OffcanvasProps, "ref"> & React.RefAttributes<ModalHandle>> & {
    Body: import("@restart/ui/types").DynamicRefForwardingComponent<"div", import("./OffcanvasBody.js").OffcanvasBodyProps>;
    Header: React.ForwardRefExoticComponent<import("./OffcanvasHeader.js").OffcanvasHeaderProps & React.RefAttributes<HTMLDivElement>>;
    Title: import("@restart/ui/types").DynamicRefForwardingComponent<"div", import("./OffcanvasTitle.js").OffcanvasTitleProps>;
};
