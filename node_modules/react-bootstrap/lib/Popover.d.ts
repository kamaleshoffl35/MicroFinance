...
declare const _default: React.ForwardRefExoticComponent<PopoverProps & React.RefAttributes<HTMLDivElement>> & {
    Header: import("@restart/ui/types").DynamicRefForwardingComponent<"div", import("./PopoverHeader.js").PopoverHeaderProps>;
    Body: import("@restart/ui/types").DynamicRefForwardingComponent<"div", import("./PopoverBody.js").PopoverBodyProps>;
