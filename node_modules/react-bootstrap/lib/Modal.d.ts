...
declare const _default: React.ForwardRefExoticComponent<Omit<ModalProps, "ref"> & React.RefAttributes<ModalHandle>> & {
    Body: import("@restart/ui/types").DynamicRefForwardingComponent<"div", import("./ModalBody.js").ModalBodyProps>;
    Header: React.ForwardRefExoticComponent<import("./ModalHeader.js").ModalHeaderProps & React.RefAttributes<HTMLDivElement>>;
    Title: import("@restart/ui/types").DynamicRefForwardingComponent<"span", import("./ModalTitle.js").ModalTitleProps>;
    Footer: import("@restart/ui/types").DynamicRefForwardingComponent<"div", import("./ModalFooter.js").ModalFooterProps>;
    Dialog: React.ForwardRefExoticComponent<import("./ModalDialog.js").ModalDialogProps & React.RefAttributes<HTMLDivElement>>;
