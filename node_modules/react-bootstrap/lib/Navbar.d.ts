...
declare const _default: DynamicRefForwardingComponent<"nav", NavbarProps> & {
    Brand: DynamicRefForwardingComponent<"a", import("./NavbarBrand.js").NavbarBrandProps>;
    Collapse: React.ForwardRefExoticComponent<import("./NavbarCollapse.js").NavbarCollapseProps & React.RefAttributes<HTMLDivElement>>;
    Offcanvas: React.ForwardRefExoticComponent<Omit<import("./NavbarOffcanvas.js").NavbarOffcanvasProps, "ref"> & React.RefAttributes<import("@restart/ui/Modal").ModalHandle>>;
    Text: DynamicRefForwardingComponent<"span", import("./NavbarText.js").NavbarTextProps>;
    Toggle: DynamicRefForwardingComponent<"button", import("./NavbarToggle.js").NavbarToggleProps>;
};
