...
const validate = () => {
  ...
  if (loanType === "Gold Loan") {
    ...
    if (!goldPhoto) return "Upload gold photo";
  }
  ...
  if (loanType === "Vehicle Loan") {
    ...
    if (!vehiclePhoto) return "Upload vehicle photo";
  }
          ...
          <Card.Body className="text-center">
            ...
            src={`${FILE_BASE_URL}${documents.aadhaarFront}`}
              ...
              className="img-fluid rounded mt-2"
                onClick={() =>
    handlePreview(`${FILE_BASE_URL}${documents.aadhaarFront}`)
  }
              style={{
                height: "180px",
                objectFit: "cover",
          ...
          <Card.Body className="text-center">
            ...
            <img
             src={`${FILE_BASE_URL}${documents.aadhaarBack}`}
              ...
              className="img-fluid rounded mt-2"
              onClick={() =>
  handlePreview(`${FILE_BASE_URL}${documents.aadhaarBack}`)
}
              style={{
                height: "180px",
                objectFit: "cover",
          ...
          <Card.Body className="text-center">
            ...
            <img
             src={`${FILE_BASE_URL}${documents.panCard}`}
              ...
              className="img-fluid rounded mt-2"
              onClick={() =>
handlePreview(`${FILE_BASE_URL}${documents.panCard}`)
}
              style={{
                height: "180px",
                objectFit: "cover",
        ...
        <Card className="border rounded-3">
          <Card.Body className="text-center">
            ...
            <img
              ...
              className="img-fluid rounded mt-2"
              onClick={() =>
handlePreview(`${FILE_BASE_URL}${documents.passportPhoto}`)
}
              style={{
                height: "180px",
                objectFit: "cover",
        ...
        <Card className="border rounded-3">
          <Card.Body className="text-center">
            ...
            <img
              ...
              className="img-fluid rounded mt-2"
              onClick={() =>
handlePreview(`${FILE_BASE_URL}${documents.signature}`)
}
              style={{
                height: "180px",
                objectFit: "cover",
          ...
          <Card.Body className="text-center">
            ...
            <img
             src={`${FILE_BASE_URL}${documents.incomeProof}`}
              ...
              className="img-fluid rounded mt-2"
              onClick={() =>
  handlePreview(`${FILE_BASE_URL}${documents.incomeProof}`)
}
              style={{
                height: "180px",
                objectFit: "cover",
